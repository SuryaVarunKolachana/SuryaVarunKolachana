...
- 🧠 AI: `GPT-4o`, `Protocol Buffers`, `AES Encryption`  
- 🔐 Backend: `Spring Boot`, `Flask`, `JWT`, `REST`, `WebSocket`  
- 💡 Other: `OOP`, `DSA`, `Agile`, `Cert Prep (OCA Java)`
...
- 🤝 Flask backend collaboration project  
- 📊 National competitions (FBLA, GATSA)  
- 📚 Volunteering @ AGTTA & Fulton Library System  
